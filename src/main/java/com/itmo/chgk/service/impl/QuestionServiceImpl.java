...
public class QuestionServiceImpl implements QuestionService {
    ...
    public QuestionInfoResponse createQuestion(QuestionInfoRequest request) {
        ...
        question.setUserDetail(loggedUserManagementService.getUserDetail());
    ...
    public QuestionInfoResponse updateQuestion(Long id, QuestionInfoRequest request) {
        ...
        if (!loggedUserManagementService.getUserDetail().getRole().equals(UserRole.ADMIN) &&
                !question.getUserDetail().getId().equals(loggedUserManagementService.getUserDetail().getId())) {
